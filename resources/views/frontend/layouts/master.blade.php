...
<link href="{{asset('/')}}/frontend/toastr/build/toastr.min.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
...
<body>
	<div class="preloader text-center">
		...
		<img src="{{asset('/')}}/frontend/images/giphy.gif" style="height: 30px; width:40px;" alt="preloader-image">
		</div>
	</div>
